...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full relative bg-gray-100 backdrop-blur-lg rounded-3xl font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-5xl font-bold mb-4 text-black0 max-w-4xl">
          WHAT TO DO
        </h2>
        <h3 className=" text-gray-600 font-normal text-lg max-w-[50%]">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-black border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
