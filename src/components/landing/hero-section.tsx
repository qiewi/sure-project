  ...
  return (
    <section className="relative">
      <div className="flex flex-col w-full h-[100%]">
        ...
        {/* Cards Section */}
        <div className="flex relative justify-center -mt-20 z-10">
          <div className="flex space-x-4">
            {CardProps.map((card, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center w-[200px] sm:w-[250px] border border-gray-200"
              >
